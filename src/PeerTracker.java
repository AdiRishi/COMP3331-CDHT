...
public class PeerTracker extends TimerTask {
    ...
    public void registerGracefulDepart (int peerId, List<Integer> givenSucc) {
        System.out.println("Peer " + peerId + " has departed the network");
        ...
        successors.remove(new Peer(peerId));
        ...
        System.out.println("New SUCC - " + successors);
    }
    ...
    public ArrayList<Integer> getPredecessors() {
        ...
        Collections.sort(r);
        System.out.println("Sending departing message to - " + r);
        return r;
    }
